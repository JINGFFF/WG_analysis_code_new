...
for i in range(len(h)):
    if i == 13:
        read_hist('hist_in_', h[i], indir, which_year, which_channel, setting_for_h[i][1], which_region, barrel_or_endcap, setting_for_h[i][0])
        set_hist(h[i], setting_for_h[i][0], setting_for_h[i][1], setting_for_h[i][2])
    if i == 16:
        read_hist('hist_out_', h[i], indir, which_year, which_channel, setting_for_h[i][1], which_region, barrel_or_endcap, setting_for_h[i][0])
        set_hist(h[i], setting_for_h[i][0], setting_for_h[i][1], setting_for_h[i][2])
    else:
...
leg1.AddEntry(h[13],  "WGJJ in", "f");
leg1.AddEntry(h[16],  "WGJJ out", "f");
