...
###### interference
./make_hist_mc filelist_dir3/tight_for_analysis_WGJJ_interference.txt $1 2018 electron mc aqgc all WGJJ_interference medium T
./make_hist_mc filelist_dir3/tight_for_analysis_WGJJ_interference.txt $1 2018 muon mc aqgc all WGJJ_interference medium T
