...
for i in range(1,VBS.GetNbinsX()+1):
    ...
    f.write('WGJJ_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t'+str(VBS_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('WGJets_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i) + '\tlnN')
    f.write('\t-\t'+str(WGJets_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('ST_s_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t'+str(ST_s_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('ST_t_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i) + '\tlnN')
    f.write('\t-\t-\t-\t'+str(ST_t_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('ST_tbar_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t-\t-\t'+str(ST_tbar_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('ST_tW_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t'+str(ST_tW_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('ST_tbarW_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t-\t'+str(ST_tbarW_binerror)+'\t-\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('TTG_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t-\t-\t'+str(TTG_binerror)+'\t-\t-\t-\t-\t-\t-\t-\n')

    f.write('WW_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i)  + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t-\t-\t-\t'+str(WW_binerror)+'\t-\t-\t-\t-\t-\t-\n')

    f.write('WZ_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i) + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t-\t-\t-\t-\t'+str(WZ_binerror)+'\t-\t-\t-\t-\t-\n')

    f.write('ZZ_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i) + '\tlnN')
    f.write('\t-\t-\t-\t-\t-\t-\t-\t-\t-\t-\t'+str(ZZ_binerror)+'\t-\t-\t-\t-\n')

    f.write('ZG_'+ region + '_' +channel+'_'+bORe+'_stat_bin_'+ str(i) + '\tlnN')
