...
#include "mytool/hist/hist_jet1pt.C"
#include <vector>
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < pho_eta_high && fabs(fill_photonsceta) > pho_eta_low){
         ...
         if(m_sample == "data") {
            ...
            double fill_reco[5] = {fill_jet1pt, fill_jet1pt_JEC_up, fill_jet1pt_JEC_down, fill_jet1pt_JER_up, fill_jet1pt_JER_down};
            double fill_gen  = genjet1pt;
            if(cut1){
