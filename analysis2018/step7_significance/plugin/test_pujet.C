...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < pho_eta_high && fabs(fill_photonsceta) > pho_eta_low){
         ...
         if(m_sample == "data") {
            ...
            if(cut1){ 
//cout<<jentry<<" "<<weight<<" "<<cross_section_SF<<" "<<pu_weight_SF<<" "<<photon_ID_SF<<" "<<electron_ID_SF<<" "<<electron_Reco_SF<<" "<<electron_HLT_SF<<" "<<muon_ID_SF<<" "<<muon_iso_SF<<" "<< muon_HLT_SF<<" "<<btag_jet1_SF<<" "<<btag_jet2_SF<<" "<<pu_jet1_SF<<" "<<pu_jet2_SF<<" "<<pu_jet1_mistag_SF<<" "<<pu_jet2_mistag_SF<<endl;
//cout<<"1-------------"<<endl;

double xx1 = get_puIdweight_mistag_SF(fill_genjet_eta, fill_genjet_phi, *jet1eta_new, *jet1phi_new, *jet1pt_new, h2_eff_mc2017_T, h2_eff_sf2017_T, h2_eff_sf2017_T_Systuncty, fill_jet1puId, "center");
//cout<<"2-------------"<<endl;

double xx2 = get_puIdweight_mistag_SF(fill_genjet_eta, fill_genjet_phi, *jet2eta_new, *jet2phi_new, *jet2pt_new, h2_eff_mc2017_T, h2_eff_sf2017_T, h2_eff_sf2017_T_Systuncty, fill_jet2puId, "center");
//cout<<"-------------"<<endl;
