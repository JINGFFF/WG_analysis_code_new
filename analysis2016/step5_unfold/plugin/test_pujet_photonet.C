...
#include "mytool/hist/hist_photonet.C"
#include <vector>
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < pho_eta_high && fabs(fill_photonsceta) > pho_eta_low){
         ...
         if(m_sample == "data") {
            ...
            double fill_reco[5] = {fill_photonet, fill_photonet, fill_photonet, fill_photonet, fill_photonet};
            double fill_gen  = genphotonet;
