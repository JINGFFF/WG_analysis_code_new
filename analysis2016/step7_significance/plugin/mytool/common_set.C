using namespace std;
   ...
   // electron HLT weight
   TFile * electron_HLT_weight_input = new TFile ("./scalef/electron/Run2_electron_hlt.root");
   TH2D* h_electron_HLT_weight = (TH2D*)electron_HLT_weight_input->Get("HLT_2016");
